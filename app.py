...
def handle_message(event):
    ...
    if message_text == '12345':
        line_bot_api.reply_message(event.reply_token, TextSendMessage(text="Thanks for your response!"))
    else:
        # Handle other messages
        line_bot_api.reply_message(event.reply_token, TextSendMessage(text="I didn't understand that."))
...
def handle_postback(event):
    ...
    if data == 'action=show_amount':
        ...
        line_bot_api.reply_message(event.reply_token, TextSendMessage(text="Please type '12345' to confirm."))
